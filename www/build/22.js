...
var LoginPage = /** @class */ (function () {
    ...
    LoginPage.prototype.login = function () {
        ...
        this.http.callApi(loginRequestJson, this.codes.API_AUTHENTICATE_USER).then(function (responseJson) {
            ...
            _this.navCtrl.setRoot('DashboardTabPage');
        }, function (error) {
            loading.dismiss();
            console.error(error);
